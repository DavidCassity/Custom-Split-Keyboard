module.exports = {
  params: {
    designator: 'MCU',
    orientation: 'down',
    type: 'nicenano', // must be promicro, nicenano, or elitec
  ...
  body: p => {
    ...
    function pins(def_neg, def_pos) {
      ...
      return `
        ...
        (pad 1 thru_hole circle (at -13.97 ${def_pos}7.62 0) (size 1.7526 1.7526) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) ${p.RAW.str})
